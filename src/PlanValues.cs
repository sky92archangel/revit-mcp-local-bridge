namespace RevitCommandBridge
{
    ...
    internal static class PlanValues
    {
        ...
        public static bool Boolean(IDictionary<string, object> values, bool defaultValue, params string[] names)
        {
            ...
            throw new BridgeCommandException("参数 " + string.Join("/", names) + " 必须�?true �?false�?);
        }
        ...
        /// <summary>
        /// �?Revit XYZ 点转回毫米单位的字典�?/ Converts a Revit XYZ point back to a millimeter-unit dictionary.
        /// </summary>
        ...
        /// <summary>
        /// 英尺转毫米，四舍五入�?3 位小数�?/ Converts feet to millimeters, rounded to 3 decimal places.
        /// </summary>
        ...
        /// <summary>
        /// 将值解析为毫米长度，支�?"mm" �?"m" 后缀以及中文字段�?/ Parses a value as millimeter length, supporting "mm" and "m" suffixes and Chinese units.
        /// </summary>
